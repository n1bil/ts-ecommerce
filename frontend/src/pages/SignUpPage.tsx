        ...
        <Container className="small-container">
            ...
            <Form onSubmit={submitHandler}>
                <Form.Group className="mb-3" controlId="username">
                    ...
                    <Form.Control onChange={(event) => setUsername(event.target.value)} required />
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="confirmPassword">
                    ...
                    <Form.Control type="password" onChange={(event) => setConfirmPassword(event.target.value)} required />
                </Form.Group>
